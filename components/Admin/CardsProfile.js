...
function CardProfile(props) {
  let { id, name, url_image, url_linkedin, position } = props;
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const deleteThis = async (id) => {
          try {
            const response = await fetch(`../api/admin/profile?id=${id}`, {
              method: "DELETE",
            });
    ...
    <>
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          ></img>
          <h3 className="m-0 mb-3 p-0">Update Data</h3>
          <Form>
            ...
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">
                  URL Google Drive Image Profile (1000 x 750)
                </h5>
                <Input
                  type="text"
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                ...
                <Input
                  type="text"
                  defaultValue={`${newData.url_linkedin}`}
                  onChange={(e) => {
                    setNewData({
                      ...newData,
