...
// core components
import CardBrands from "components/Admin/CardsBrands.js";
...
function Liputan() {
  ...
  const getAll = async () => {
    const data = await fetchWrapper.get(`../api/admin/brands`);
    if (data) {
      setResult(data.data);
    }
  };
    ...
    <>
      <Col xl="9" style={{ paddingLeft: "7.5px", paddingRight: "7.5px" }}>
        <Card style={{ height: "100%" }}>
            ...
            <Container>
              <div className="py-3">
                <Row className="align-items-center">
                  <Col>
                    <h3 className="mb-0">List Previous Partner</h3>
                  </Col>
                  <Button
          ...
          <Container>
            {result.map((val) => {
              return (
                <CardBrands id={val.id} url={val.urlOrigin} name={val.name} />
              );
            })}
          </Container>
        </Card>
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          ></img>
          <h3 className="m-0 mb-3 p-0">Tambah Previous Partner</h3>
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Nama Previous Partner</h5>
                <Input
                  type="text"
            ...
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">
                  URL Google Drive Image Previous Partner
                </h5>
                <Input
                  type="text"
