...
// core components
import CardPartnerSponsorhip from "components/Cards/Admin/CardsPartnerSponsorhip.js";
...
function PartnerSponsorhip() {
  ...
  const getAll = async () => {
    const data = await fetchWrapper.get(`../api/admin/partnership`);
    if (data) {
      setResult(data.data);
    }
  };
    ...
    <>
            ...
            <Container>
              <div className="py-3">
                <Row className="align-items-center">
                  <Col>
                    <h3 className="mb-0">List Partership Film Festival</h3>
                  </Col>
                  <Button
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          ></img>
          <h3 className="m-0 mb-3 p-0">Tambah Ticket Platform</h3>
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Nama Partner</h5>
                <Input
                  type="text"
                  defaultValue={`${dataValue.name_partner}`}
                  onChange={(e) => {
                    setDataValue({
                      ...dataValue,
                      name_partner: `${e.target.value}`,
                    });
                  }}
                />
              </Col>
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">URL Google Drive Image Partner</h5>
                <Input
                  type="text"
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">URL for Partner</h5>
                <Input
                  type="text"
                  defaultValue={`${dataValue.url_partner}`}
                  onChange={(e) => {
                    setDataValue({
                      ...dataValue,
                      url_partner: `${e.target.value}`,
                    });
                  }}
                />
              </Col>
...
PartnerSponsorhip.layout = HomeLayoutAdmin;

export default PartnerSponsorhip;
