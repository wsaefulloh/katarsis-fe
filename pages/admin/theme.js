...
// core components
import CardGenre from "components/Cards/Admin/CardsTheme.js";
...
function ThemePage() {
  ...
  const getAllTheme = async () => {
    const data = await fetchWrapper.get(`../api/admin/theme`);
    if (data) {
      setTheme(data.data);
    }
  };
    ...
    try {
      ...
      if (data) {
        if (data.statusCode != 201) {
          ...
          await Swal.fire("OK", "Tema berhasil ditambahkan", "success");
    ...
    <>
      <Col xl="9" style={{ paddingLeft: "7.5px", paddingRight: "7.5px" }}>
        <Card style={{ height: "100%" }}>
            ...
            <Container>
              <div className="py-3">
                <Row className="align-items-center">
                  <Col>
                    <h3 className="mb-0">List Format</h3>
                  </Col>
                  <Button
          ...
          <Container>
            {theme.map((val) => {
              return <CardGenre id={val.id} theme={val.name_theme} />;
            })}
          </Container>
        </Card>
      </Col>
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          ></img>
          <h3 className="m-0 mb-3 p-0">Tambah Format</h3>
          <Form>
...
ThemePage.layout = HomeLayoutAdmin;
