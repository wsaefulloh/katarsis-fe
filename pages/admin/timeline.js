...
function Timeline() {
  ...
  const getAll = async () => {
    const data = await fetchWrapper.get(`../api/admin/timeline`);
    if (data) {
      setResult(data.data);
    }
  };
    ...
    <>
      <Col xl="9" style={{ paddingLeft: "7.5px", paddingRight: "7.5px" }}>
        <Card style={{ height: "100%" }}>
            ...
            <Container>
              <div className="py-3">
                <Row className="align-items-center">
                  <Col>
                    <h3 className="mb-0">List Timeline</h3>
                  </Col>
                  <Button
          ...
          <Container>
            {result.map((val) => {
              return (
                <CardTimeline id={val.id} date={val.date} title={val.title} />
              );
            })}
          </Container>
        </Card>
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          ></img>
          <h3 className="m-0 mb-3 p-0">Tambah Timeline</h3>
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Nama Timeline</h5>
                <Input
                  type="text"
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Tanggal Timeline</h5>
                <Input
                  type="text"
...
Timeline.layout = HomeLayoutAdmin;
