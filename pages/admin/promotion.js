...
// core components
import CardPromotion from "components/Cards/Admin/CardsPromotion.js";
...
function Promotion() {
  ...
  const getAll = async () => {
    const data = await fetchWrapper.get(`../api/admin/promotion`);
    if (data) {
      setResult(data.data);
    }
  };
    ...
    <>
            ...
            <Container>
              <div className="py-3">
                <Row className="align-items-center">
                  <Col>
                    <h3 className="mb-0">List Event & Promotion</h3>
                  </Col>
                  <Button
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          ></img>
          <h3 className="m-0 mb-3 p-0">Tambah Event & Promotion</h3>
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Judul Event & Promotion</h5>
                <Input
                  type="text"
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Deskripsi Event & Promotion</h5>
                <Input
                  type="text"
            ...
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">
                  URL Google Drive Image Event & Promotion (1000 x 1000)
                </h5>
                <Input
                  type="text"
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">
                  Status Active Event & Promotion (true/false)
                </h5>
                <Input
                  type="text"
                  defaultValue={`${dataValue.status_active}`}
                  onChange={(e) => {
...
Promotion.layout = HomeLayoutAdmin;
