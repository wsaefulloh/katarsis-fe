...
// core components
import CardJudges from "components/Cards/Admin/CardsJudges.js";
...
function Judges() {
  ...
  const getAll = async () => {
    const data = await fetchWrapper.get(`../api/admin/judges`);
    if (data) {
      setResult(data.data);
    }
  };
    ...
    <>
            ...
            <Container>
              <div className="py-3">
                <Row className="align-items-center">
                  <Col>
                    <h3 className="mb-0">List Judges Film Festival</h3>
                  </Col>
                  <Button
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          ></img>
          <h3 className="m-0 mb-3 p-0">Tambah Judges Film Festival</h3>
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Nama Judges</h5>
                <Input
                  type="text"
                  defaultValue={`${dataValue.name_judges}`}
                  onChange={(e) => {
                    setDataValue({
                      ...dataValue,
                      name_judges: `${e.target.value}`,
                    });
                  }}
                />
              </Col>
            ...
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">
                  URL Google Drive Image Judges (1000 x 750)
                </h5>
                <Input
                  type="text"
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Description Judges</h5>
                <Input
                  type="text"
