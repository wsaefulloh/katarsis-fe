...
// core components
import CardHomeBoard from "components/Cards/Admin/CardsHomeBoard.js";
...
function HomeBoard() {
  ...
  const getAll = async () => {
    const data = await fetchWrapper.get(`../api/admin/home-board`);
    if (data) {
      setResult(data.data);
    }
  };
  ...
  const addData = async () => {
    setLoading(true);
    try {
      const response = await fetch(`../api/admin/home-board`, {
        method: "POST",
        headers: {
    ...
    <>
            ...
            <Container>
              <div className="py-3">
                <Row className="align-items-center">
                  <Col>
                    <h3 className="mb-0">List Home Board</h3>
                  </Col>
                  <Button
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          ></img>
          <h3 className="m-0 mb-3 p-0">Tambah Home Board</h3>
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Judul Home Board</h5>
                <Input
                  type="text"
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Deskripsi Home Board</h5>
                <Input
                  type="text"
            ...
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">
                  URL Google Drive Image Home Board (399 x 266)
                </h5>
                <Input
                  type="text"
...
HomeBoard.layout = HomeLayoutAdmin;
