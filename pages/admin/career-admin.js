...
function SocialLinks() {
  ...
  const updateVideo = async (dataUpdate) => {
    setLoading(true);
    try {
    ...
    <>
            ...
            <Container>
              <div className="py-3">
                <Row className="align-items-center">
                  <Col>
                    <h3 className="mb-0">Status Page Career</h3>
                  </Col>
                </Row>
          ...
          <Card>
            <Container>
              <div className="py-3">
                <Row className="align-items-center">
                  <Col>
                    <h3 className="mb-0">Edit Video Page Career</h3>
                  </Col>
                  <Button
                    className="m-1 border-0 py-1 px-3"
                    style={{
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          ></img>
          <h3 className="m-0 mb-3 p-0">Update Status Career</h3>
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5>Status Career (True / False)</h5>
                <Input
                  type="text"
                  defaultValue={`${result1.description}`}
                  onChange={(e) => {
      ...
      >
        <div className="justify-content-center text-center p-4">
          <img
            ...
            src="data:image/png;base64,"
          ></img>
          <h3 className="m-0 mb-3 p-0">Update Video Career</h3>
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    if (file.type === "video/mp4") setVideo(file);
                  }}
                />
              </Col>
            </div>
