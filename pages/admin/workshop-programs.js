...
// core components
import CardWorkshop from "components/Cards/Admin/CardsWorkshop.js";
...
function Workshop() {
  ...
  const getAll = async () => {
    const data = await fetchWrapper.get(`../api/admin/workshop`);
    if (data) {
      setResult(data.data);
    }
  };
    ...
    <>
            ...
            <Container>
              <div className="py-3">
                <Row className="align-items-center">
                  <Col>
                    <h3 className="mb-0">List Workshop</h3>
                  </Col>
                  <Button
            ...
            {result.map((val) => {
              return (
                <CardWorkshop
                  ...
                  name_workshop={val.name_workshop}
                  url_form={val.url_form}
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          ></img>
          <h3 className="m-0 mb-3 p-0">Tambah Workshop</h3>
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Nama Workshop</h5>
                <Input
                  type="text"
                  defaultValue={`${dataValue.name_workshop}`}
                  onChange={(e) => {
                    setDataValue({
                      ...dataValue,
                      name_workshop: `${e.target.value}`,
                    });
                  }}
                />
              </Col>
            ...
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">
                  URL Google Drive Image Workshop (1000 x 1000)
                </h5>
                <Input
                  type="text"
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Description Workshop</h5>
                <Input
                  type="text"
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Link Form Daftar Workshop</h5>
                <Input
                  type="text"
                  defaultValue={`${dataValue.url_form}`}
                  onChange={(e) => {
                    setDataValue({
                      ...dataValue,
                      url_form: `${e.target.value}`,
                    });
                  }}
                />
              </Col>
...
Workshop.layout = HomeLayoutAdmin;
