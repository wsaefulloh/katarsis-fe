...
// core components
import CardBanner from "../../components/Admin/CardsBanner";
...
function Banner() {
  ...
  const getAll = async () => {
    const data = await fetchWrapper.get(`../api/admin/banner`);
    if (data) {
      setResult(data.data);
    }
  };
  ...
  const addData = async () => {
    let string = dataValue.title_banner;
    ...
    <>
            ...
            <Container>
              <div className="py-3">
                <Row className="align-items-center">
                  <Col>
                    <h3 className="mb-0">List Banner</h3>
                  </Col>
                  <Button
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          ></img>
          <h3 className="m-0 mb-3 p-0">Tambah Banner</h3>
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                ...
                <Input
                  type="text"
                  defaultValue={`${dataValue.title_banner}`}
                  onChange={(e) => {
                    setDataValue({
                      ...dataValue,
            ...
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">
                  URL Google Drive Image (1440px x 500px)
                </h5>
                <Input
                  type="text"
          ...
          {/* <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                ...
                <Input
                  type="text"
                  defaultValue={`${dataValue.date_banner}`}
                  onChange={(e) => {
                    setDataValue({
                      ...dataValue,
